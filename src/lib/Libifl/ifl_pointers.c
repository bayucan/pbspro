...
int (*pfn_pbs_inter_connect_job)(int, char *, char *, char *, char *) = __pbs_inter_connect_job;
int (*pfn_pbs_inter_disconnect_job)(int, char *, char *) = __pbs_inter_disconnect_job;
